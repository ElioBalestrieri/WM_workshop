...
Screen('TextSize', P.ptb.win, 25);

welcometxt = ['Welcome to the WM workshop!'...
    '\n\n Different classical WM experiments are displayed'...
    '\n\n You''ll provide a response with "y" or with "m"'...
    '\n\n Regardless of the task, Y is to report a difference, M to establish equality'...
    '\n\n Press any key to start!'];

DrawFormattedText(P.ptb.win, welcometxt,...
